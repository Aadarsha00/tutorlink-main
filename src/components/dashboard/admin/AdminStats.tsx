  ...
  const stats = [
    {
      ...
      subValue: `${formatNumber(summary?.active_users)} active`,
    ...
    },
    {
      ...
      subValue: `${formatCurrency(summary?.monthly_revenue)} this month`,
      icon: DollarCircleIcon,
      color: "emerald",
    },
    {
      label: "Platform Health",
      value: `${formatNumber(summary?.health_score)}%`,
      subValue: `${summary?.growth_rate || 0}% growth`,
      icon: TrendingUp,
      color: "purple",
    },
  ];
